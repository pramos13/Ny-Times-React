...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Router = __webpack_require__(159);
	var Articles = __webpack_require__(232);
	var helpers = __webpack_require__(211);
			...
			if (!this.props.results.hasOwnProperty('docs')) {
				...
				var articles = this.props.results.docs.map(function (article, index) {
					return React.createElement(
						...
						article.snippet && React.createElement(
							'p',
							null,
							article.snippet
						),
						React.createElement(
							'button',
							{ className: 'btn btn-primary', onClick: this.handleSubmit, 'data-index': index },
							'Save'
						)
					);
				}.bind(this));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var helpers = {
		...
		runQuery: function runQuery(term, start, end, callback) {
		...
		getSaved: function getSaved(callback) {
		...
		postSaved: function postSaved(data) {
			...
			if (this.state.savedArticles == "") {
				...
				var articles = this.state.savedArticles.map(function (article, index) {
					return React.createElement(
						'li',
						{ className: 'list-group-item', key: index },
						article.url && React.createElement(
							'h4',
							null,
							React.createElement(
								'a',
						...
						article.text && React.createElement(
							'p',
							null,
							article.text
						),
						article.date && React.createElement(
							'p',
							null,
							article.date
						),
						React.createElement(
							'button',
							{ className: 'btn btn-primary', onClick: this.handleSubmit, 'data-index': article._id },
							'Delete'
						)
					);
				}.bind(this));
